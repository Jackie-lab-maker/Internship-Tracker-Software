...
**XYIntern** is a web application designed to help students efficiently track and manage internship applications across multiple recruiting cycles. An  internship application tracker software built with Vanilla JS, HTML, and CSS. 
